...
DATA_PATH = "/home/intel/pp_datasets/training/velodyne_reduced"
MODEL = "pfe.xml"
...
def main():
    ...
    quantized_model = nncf.quantize(model, datasets, **quantize_config)
    ov.save_model(quantized_model, QUANT_MODEL)
